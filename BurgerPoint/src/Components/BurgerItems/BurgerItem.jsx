...
function BurgerItem({burger}) {
  ...
  return (
	...
	<div className="flex flex-col justify-between p-6 space-y-8">
		...
		<button onClick={() => handleAddToCart(burger)} type="button" className="flex items-center justify-center w-full p-3 font-semibold tracking-wide rounded-md dark:bg-violet-700 bg-yellow-400 text-gray-50 hover:bg-yellow-500 hover:text-white">Add to Cart</button>
	</div>
</div>
  )
}
